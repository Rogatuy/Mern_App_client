...
export const getAllUsers = createAsyncThunk(
  ...
  try {
    const {data} = await axios.get('https://mern-app-server.onrender.com/api/users');
    return data;
  } catch (error) {
    console.log(error);
  }
...
export const removeUser = createAsyncThunk(
  ...
  async (_id) => { 
    try{
      const {data} = await axios.delete('https://mern-app-server.onrender.com/api/users/delete', {
        data:{_id}
      });
...
export const blockedUser = createAsyncThunk(
  ...
  async ({_id}) => { 
    try{
      const {data} = await axios.post('https://mern-app-server.onrender.com/api/users/blocked', {
        _id,
      });
...
export const unblockedUser = createAsyncThunk(
  ...
  async ({_id}) => { 
    try{
      const {data} = await axios.post('https://mern-app-server.onrender.com/api/users/unblocked', {
        _id,
      });
